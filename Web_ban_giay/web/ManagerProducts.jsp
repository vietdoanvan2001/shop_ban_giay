...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal"  class="btn btn-success" data-toggle="modal"> <span>Thêm sản phẩm</span></a>
                            <a href="./QLHoaDon.jsp"  class="btn btn-success" data-toggle="modal"> <span>Quản lí hóa đơn</span></a>
                            <a href="./QLXacNhan.jsp"  class="btn btn-success" data-toggle="modal"> <span>Quản lí đơn đã xác nhận</span></a>
            ...
            <a href="Home" type="button" class="btn btn-primary">Quay lại</a>
                   ...
                   <form action="add" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="priceOld" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
